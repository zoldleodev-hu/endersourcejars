...
public class EnderSourceJarRenderer implements BlockEntityRenderer<EnderSourceJarEntity> {
    ...
    private static final RenderType lidType = RenderType.entitySolid(ResourceLocation.fromNamespaceAndPath(EnderSourceJars.MODID, "textures/block/source_jar.png"));
    private static final RenderType lockType = RenderType.entitySolid(ResourceLocation.fromNamespaceAndPath(EnderSourceJars.MODID, "textures/block/source_jar_lock.png"));
    private static final Material sourceMaterial = ClientHooks.getBlockMaterial(ResourceLocation.fromNamespaceAndPath(MODID, "block/mana_still"));
